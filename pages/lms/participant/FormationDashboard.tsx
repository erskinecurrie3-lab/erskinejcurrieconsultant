...
export default function FormationDashboard() {
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-black mb-2">Formation Dashboard</h1>
        <p className="text-gray-600">Track your worship builder formation journey</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="border-2 border-[#F4E2A3]">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">3 / 6</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Practicum</CardTitle>
            <Clock className="h-4 w-4 text-blue-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-black">45 hrs</div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Your Formation Journey</CardTitle>
          <CardDescription>Continue building your worship leadership skills</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12 text-gray-500">
            <BookOpen className="h-16 w-16 mx-auto mb-4 text-gray-400" />
            <p className="text-lg font-medium mb-2">Keep Learning</p>
